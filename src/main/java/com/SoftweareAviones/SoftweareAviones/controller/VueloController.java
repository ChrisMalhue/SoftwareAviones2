...
import com.SoftweareAviones.SoftweareAviones.services.VueloService;
...
public class VueloController {
    ...
    @PatchMapping("/{id}")
    public ResponseEntity<Vuelo> editarVuelo(@PathVariable Integer id, @Valid @RequestBody Vuelo vuelo) {
        try {
            vuelo.setID_vuelo(id);
            Vuelo vueloEditado = vueloService.agregarVuelo(vuelo);
