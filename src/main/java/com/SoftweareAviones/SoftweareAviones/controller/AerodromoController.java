...
import com.SoftweareAviones.SoftweareAviones.DTO.AerodromoDTO;
import com.SoftweareAviones.SoftweareAviones.model.Aerodromo;
import com.SoftweareAviones.SoftweareAviones.services.AerodromoService;
...
public class AerodromoController {
    ...
    @PatchMapping("/{id}")
    public ResponseEntity<Aerodromo> editarAerodromo(@PathVariable Integer id, @Valid @RequestBody Aerodromo aerodromo) {
        try {
            aerodromo.setID_aerodromo(id);
            Aerodromo editado = aerodromoService.guardarAerodromo(aerodromo);
