...
import com.SoftweareAviones.SoftweareAviones.DTO.PilotoDTO;
import com.SoftweareAviones.SoftweareAviones.model.Piloto;
import com.SoftweareAviones.SoftweareAviones.services.PilotoService;
...
public class PilotoController {
    ...
    @PatchMapping("/{id}")
    public ResponseEntity<Piloto> editarPiloto(@PathVariable Integer id, @Valid @RequestBody Piloto piloto) {
        try {
            piloto.setID_piloto(id);
            Piloto pilotoEditado = pilotoService.guardarPiloto(piloto);
