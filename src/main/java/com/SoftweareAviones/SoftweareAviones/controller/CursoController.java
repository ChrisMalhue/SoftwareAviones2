...
import com.SoftweareAviones.SoftweareAviones.services.CursoService;
...
public class CursoController {
    ...
    @PatchMapping("/{id}")
    public ResponseEntity<Curso> editarCurso(@PathVariable Integer id, @Valid @RequestBody Curso curso) {
        try {
            curso.setID_curso(id);
            Curso cursoEditado = cursoService.guardarCurso(curso);
